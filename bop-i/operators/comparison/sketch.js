...
function checkAnswer(){
  ...
  if(myOperator1 == "==" && appleList.length == 3 && orangeList.length == 3){
    // switch scene
    console.log('switch to scene 2')
    fruitSceneTwo();

  } else if (myOperator2 == "<" && (appleList.length == 3) && (orangeList.length == 5)){
    console.log('switch to scene 3')
    fruitSceneThree();

  } else if (myOperator3 == ">" && (appleList.length == 4) && (orangeList.length == 2)){
    console.log('END')
    push();
    fill('#37c3be');
